/** @file
  ...
  MSVC wrapper for __popcountdi2 intrinsic
 ...
 *
 * MSVC typically uses __popcnt64 for intrinsics, but for compiler-rt
...
int __popcountdi2_msvc(long long a) {
    return __popcountdi2(a);
}

/* Provide both names for maximum compatibility */
#pragma comment(linker, "/alternatename:___popcountdi2_msvc=___popcountdi2")
