/** @file
  ...
  Watcom wrapper for __popcountsi2 intrinsic
 ...
 *
 * Watcom typically uses __popcount for intrinsics, but for compiler-rt
...
int __popcountsi2_watcom(int a) {
    return __popcountsi2(a);
}

/* Watcom uses pragma aux for function aliasing */
#pragma aux __popcountsi2_watcom "__popcountsi2"
