...
CONST VINIL_OPCODE_INFO gVinilOpcodeTable[VINIL_OP_COUNT] = {
    ...
    /* Indexed Memory */
    [VINIL_OP_LOAD_INDEXED]  = { VINIL_OP_LOAD_INDEXED,  "LOAD.IDX",  "Load indexed",                VinilOpcatMemory,         2, TRUE,  FALSE, TRUE  },
    [VINIL_OP_STORE_INDEXED] = { VINIL_OP_STORE_INDEXED, "STORE.IDX", "Store indexed",               VinilOpcatMemory,         3, FALSE, FALSE, TRUE  },
