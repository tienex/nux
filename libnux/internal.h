...
#define NMIOP_FLUSHALL 4	/* Force TLB flush globally. */
  ...
  /*
   * This pointer can be set by users of libnux to store their private
   * data.
   */
  void *data;
 ...
 * 
 * This function it's used at hal entries, and must be called only once as it
 * clears the cpu idle status!
 */
