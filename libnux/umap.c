...
static bool
_umap_setl1e(struct umap *umap, vaddr_t va, hal_l1e_t l1e, bool alloc, pfn_t *opfn)
{
  hal_l1p_t l1p;
  hal_l1e_t oldl1e;
  pfn_t oldpfn;
  ...
  __atomic_or_fetch(&umap->tlbop, hal_l1e_tlbop (oldl1e, l1e), __ATOMIC_RELEASE);
...
bool
umap_map(struct umap *umap, vaddr_t va, pfn_t pfn, unsigned prot, pfn_t *opfn)
{
  hal_l1e_t l1e;
